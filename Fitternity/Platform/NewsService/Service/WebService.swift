...
public let newsNYbaseURL = "https://vod.fitn.in/homescreenapi"
            ...
            switch urlResponse.statusCode {
                ...
                case 200..<300:
                    if let responseBlock = self.successBlock,
                        ...
                        let newString = str.replacingOccurrences(of: "\"flags\": [],", with: "", options: .literal, range: nil)
                        let data = Data(newString.utf8)
                        responseBlock(data, urlResponse)
                    }
