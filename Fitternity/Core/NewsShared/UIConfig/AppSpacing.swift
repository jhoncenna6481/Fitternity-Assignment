...
public struct AppSpacing {
    ...
    public struct FullWidthCell {
        ...
        public static let groupWidth: NSCollectionLayoutDimension = .absolute(342) //.fractionalWidth(0.95)
        public static let groupHeight: NSCollectionLayoutDimension = .absolute(173)
