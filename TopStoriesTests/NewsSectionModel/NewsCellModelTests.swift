...
extension  XCTestCase {
    ...
    func mockNewsItem(filePath: String = "HomeScreenInStudio.json") -> HomeScreenResponse.Campaign? {
        do {
            let newsItem: HomeScreenResponse.Campaign = try TestUtil().get(from: filePath,
